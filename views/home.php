...
<p class="lead">
L'option de menu "Assistant SQL", qui se trouve dans le menu "Aide SQL", renvoie vers un site internet extérieur
qui fournit un outil de formatage de requête SQL, très pratique notamment pour formater le code source de vues SQL complexes.<br>
