...
interface intDBActiveRecord {
     ...
     * à condition que ce chargement ait abouti (on peut le contréler via la méthode isLoaded() )
     */
    function update();
     ...
     * Le tableau renvoyé est formaté de maniére à être compatible avec la classe CrudManager
     */
    ...
    /**
     * Méthode destinée à renvoyer un tableau des lignes de la table, formaté de maniére
...
abstract class DBActiveRecord implements intDBActiveRecord {
    ...
    /**
     * resource BD reéue en entrée du constructeur
     * */
    protected $db;
    ...
    public function __construct($base) {
        ...
        /*
         * certaines fonctionnalités de DB2 ne sont disponibles qu'é partir de la V6, comme par exemple NEW TABLE ()
         * si le client est en version inférieure, il est nécessaire de le paramètrer
         */
    ...
    public function create() {
        ...
        if ($this->db_version < 6) {
             ...
             * pour récupérer le dernier identifiant créé, aprés avoir
             ...
             * - si mode = *MANUAL alors on récupére la valeur de l'ID directement dans le
