...
interface DBInstanceInterface {
	...
	/**
	 * Méthode permettant de récupérer le . ou le / selon le type de nommage (SQL ou systéme) déclaré à la connexion
	 * Le nommage systéme ne s'applique que dans le cas de DB2 pour IBM i, dans tous les autres cas, c'est le .
	 * qui est renvoyé
	 */
	...
	/**
	 * Exécution d'une instruction autre que Select (Insert, Update, Delete, commande systéme...)
	 * @param string $sql
	 * @param array $args
	...
	/**
	 * Exécution d'une commande systéme (opérationnel uniquement avec DB2 pour IBM i)
	 * @param string $cmd
	 */
	 ...
	 * empécher qu'un code existant sur une autre ligne ne puisse être utilisé
	 ...
	 * Méthode à adapter à chaque base de données (é redéfinir dans la classe fille)
	 *
	 */
