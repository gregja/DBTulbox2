    ...
    public static function getScrollCursor($db, $sql, $args, $offset, $nbl_by_page, $order_by = '') {
        ...
        try {
            ...
            if ($offset > 0) {
                 ...
                 * positionnement
                 * sur la ligne né 0, quand on affiche les offsets > 0
                 * Dans le cas oé on affiche l'offset 0, il ne faut surtout pas faire
                 * ce premier positionnement, car il interfére avec celui qui est
