 ...
 * De légéres modifications ont été apportée au code initial, telles que :
 ...
 *   sont ajoutés ensuite, et le lien vers la derniére page est ajouté en fin de barre de
 *   pagination (la version initiale proposait un lien vers chaque page, ce qui
 *   donnait des résultats particuliérement laids sur des jeux de données de grande taille.
 */
