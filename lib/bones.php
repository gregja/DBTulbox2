...
abstract class microFmw {
    ...
    public static function get($route, $callback, $cnxdb, $js='') { 
        Bones::register($route, $callback, 'GET', $cnxdb, $js);
    }
    
    public static function post($route, $callback, $cnxdb, $js='') { 
        Bones::register($route, $callback, 'POST', $cnxdb, $js);
    }
    
    public static function put($route, $callback, $cnxdb, $js='') { 
        Bones::register($route, $callback, 'PUT', $cnxdb, $js);
    }
    
    public static function delete($route, $callback, $cnxdb, $js='') { 
        Bones::register($route, $callback, 'DELETE', $cnxdb, $js);
    }
...
class Bones {
    ...
    public static function register($route, $callback, $method, $cnxdb, $js) { 
        static::$cnxdb = $cnxdb;
